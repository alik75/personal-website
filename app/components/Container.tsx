...
const Container = ({ children }: Props) => {
  ...
  return (
    <div className="bg-black p-12 fixed w-screen h-screen overflow-hidden bg-gradient-radial-layout">
      <div className="rounded-[50px] bg-blue-dark pt-8 pb-12 px-5 w-full h-full relative overflow-hidden after:w-full after:h-full after:absolute after:left-0 after:top-0 after:bg-gradient-radial-layout after:backdrop-blur-3xl after:z-0">
